# PowerShell script to get AKS ServiceAccount token for Azure DevOps
...
Write-Host "Getting AKS ServiceAccount Token for Azure DevOps" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path "Create-AKSServiceAccount.yaml")) {
    Write-Host "ERROR: Create-AKSServiceAccount.yaml not found" -ForegroundColor Red
...
kubectl apply -f Create-AKSServiceAccount.yaml
...
Write-Host "AKS Cluster Connection Details" -ForegroundColor Green
Write-Host "=========================================" -ForegroundColor Green
Write-Host ""
...
Write-Host "   - Service connection name: AKS-Mosaik-Production" -ForegroundColor Gray
Write-Host ""
Write-Host "5. Click: 'Verify and save'" -ForegroundColor White
Write-Host ""
Write-Host "6. Use in your pipeline:" -ForegroundColor White
Write-Host "   service_connection: 'AKS-Mosaik-Production'" -ForegroundColor Gray
Write-Host ""
