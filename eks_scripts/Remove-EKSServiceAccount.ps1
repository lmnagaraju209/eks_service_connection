# PowerShell script to remove the Azure DevOps ServiceAccount from EKS
...
Write-Host "Remove Azure DevOps ServiceAccount from EKS" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
if (Test-Path "Create-EKSServiceAccount.yaml") {
